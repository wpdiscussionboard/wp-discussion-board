	...
	function wpdbd_general_page_settings() {
		...
		$moderation_settings = array(
			...
			'edit_topic_time_limit'              => array(
				...
				'label'       => __( 'Prevent user from editing a topic after this time (seconds)', 'wp-discussion-board' ),
				'callback'    => 'select_callback',
				'choices'     => array(
			...
			'edit_comment_disallowed'            => array(
				'id'          => 'edit_comment_disallowed',
				'label'       => __( 'Disallow editing comment', 'wp-discussion-board' ),
				'callback'    => 'checkbox_callback',
				'description' => __( 'Select this option to disable editing comment.', 'wp-discussion-board' ),
				'page'        => 'ctdb_options',
				'section'     => 'ctdb_options_settings',
			),
			'edit_comment_time_limit'              => array(
				'id'          => 'edit_comment_time_limit',
				'label'       => __( 'Prevent user from editing a comment after this time (seconds)', 'wp-discussion-board' ),
				'callback'    => 'select_callback',
				'choices'     => array(
					'0'  => __( 'Never', 'wp-discussion-board' ),
					'15'  => '15',
				...
				'description' => __( 'The number of seconds before editing a comment is closed for a user.', 'wp-discussion-board' ),
				'page'        => 'ctdb_options',
				'section'     => 'ctdb_options_settings',
			),
